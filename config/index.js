export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxec5e818e03a3280c",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "bb752459e5db638526d198942b42ec24",
   ...
   */
  USERS: [45LJQxftd58FmzafNXFdziVOcGTlrLW2xjgbjYMDj3E	
    {
      // 想要发送的人的名字
      name: "小阁",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "老婆", "year": "1966", "date": "01-01"},
      ...
      customizedDateList: [
        // 在一起的日子
        {"keyword": "love_day", date: "2018-03-16"},
        // 结婚纪念日
